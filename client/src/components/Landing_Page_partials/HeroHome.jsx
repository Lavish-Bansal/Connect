  ...
  return (
    ...
    <div className='relative bg-white overflow-hidden'>
      <div className='max-w-7xl mx-auto'>
        <div className='relative z-10 pb-2 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-10'>
          <svg
          ...
          <section className='mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28'>
            <div style={{marginTop: "-31px"}} className='sm:text-center lg:text-left'>
      ...
      <div className='lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 h-30'>
        <img
          loading='lazy'
          className='h-500 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full'
          src='/img/frontImg.jpeg'
          alt='preview'
          style={{height: "600px"}}
        />
      </div>
