...
const Navbar = () => {
  ...
  return (
    <div
      style={{ height: 74, backgroundColor: "#f05454", position: "sticky" }}
      className="flex justify-between items-center w-full h-20 px-4 text-white fixed nav"
    >
      <div style={{ display: "flex" }}>
        ...
        <h1
          ...
          className="nav-links px-4 cursor-pointer capitalize font-medium text-gray-500 hover:scale-105 text-white-500 duration-200 link-underline"
        >
          <a
